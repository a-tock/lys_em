...
To understand the features and capabilities of *lys_em*, you can use `Jupyter <https://jupyter.org/>`_.
Start Jupyter from the installed lys_em folder, then open the .ipynb files in the /lys_em/examples folder and run the tutorials.